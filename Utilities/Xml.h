	...
	*/
	...
	public:
		...
		*/
		...
		If the 'b' is null, then the nodes will
		be allocated in the current document. If 'b'
		...
		*/
		XMLNode* DeepClone(XMLDocument* b) const;
	...
	*/
	...
	public:
		...
		*/
		...
		/**
		Copies this document to a b document.
		The b will be completely cleared before the copy.
		If you want to copy a sub-tree, see XMLNode::DeepClone().

		NOTE: that the 'b' must be non-null.
		*/
		void DeepCopy(XMLDocument* b) const;
